<%@ Page Title="Stock Out Record" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="StockOut.aspx.vb" Inherits="StockOut" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                <div class="col-md-6">
                   <asp:DropDownList ID="stockoutcustomer" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="Name" CssClass="btn btn-default btn-lg btn-block">
                   </asp:DropDownList>
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [Name] FROM [Customer] ORDER BY [Name]">
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        <input class="btn btn-default btn-lg btn-block" name="stockoutdate" id="stockoutdate" type="date" />   
                    <script type="text/javascript">
                        var CurrentDate = new Date();
                        CurrentDate.setMonth(CurrentDate.getMonth());
                        document.getElementById('stockoutdate').valueAsDate = CurrentDate;
                    </script>
                    </div>
                 </div>
            </div>
			<table class="table">
                ...
                <asp:Button ID="Button1" runat="server" Text="Create Stock Out Record" OnClick="SubmitRecord"   CssClass="btn btn-primary btn-lg btn-block" />
		        
        </div>
    </div>

    <!-- Validate input functions Orginally placed in scripts/webforms/bootstrap.js but not being called -->
    <script type="text/javascript">
